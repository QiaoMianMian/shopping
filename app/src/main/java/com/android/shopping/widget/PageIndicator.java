...
public class PageIndicator extends LinearLayout {
    ...
    public static class PageMarkerResources {
        ...
        public PageMarkerResources() {
            activeId = R.mipmap.ic_pageindicator_current;
            inactiveId = R.mipmap.ic_pageindicator_default;
        }
    ...
    public void addMarkers(ArrayList<PageMarkerResources> markers, boolean allowAnimations, boolean isSetHeight) {
        for (int i = 0; i < markers.size(); ++i) {
            addMarker(Integer.MAX_VALUE, markers.get(i), allowAnimations,isSetHeight);
        }
    }

    public void addMarker(int index, PageMarkerResources marker, boolean allowAnimations,boolean isSetHeight) {
        index = Math.max(0, Math.min(index, mMarkers.size()));
        ...
        if(isSetHeight){
			FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(
                    MathUtils.dpToPx(getContext(), 20), MathUtils.dpToPx(getContext(),20));
