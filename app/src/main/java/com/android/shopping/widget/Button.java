...
public abstract class Button extends CustomView {
    ...
    protected void setDefaultProperties() {
        // Min size
        setMinimumHeight(MathUtils.dpToPx(minHeight, getResources()));
        setMinimumWidth(MathUtils.dpToPx(minWidth, getResources()));
        // Background shape
    ...
    public Bitmap makeCircle() {
        Bitmap output = Bitmap.createBitmap(
                getWidth() - MathUtils.dpToPx(6, getResources()), getHeight()
                        - MathUtils.dpToPx(7, getResources()), Config.ARGB_8888);
